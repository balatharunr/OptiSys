...
public partial class BootstrapInstallLoader : System.Windows.Controls.UserControl
{
    public static readonly DependencyProperty IsActiveProperty = DependencyProperty.Register(
        nameof(IsActive),
        typeof(bool),
        typeof(BootstrapInstallLoader),
    ...
    {
        var loader = (BootstrapInstallLoader)d;
