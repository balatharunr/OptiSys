...
public partial class BootstrapUninstallLoader : System.Windows.Controls.UserControl
{
    public static readonly DependencyProperty IsActiveProperty = DependencyProperty.Register(
        nameof(IsActive),
        typeof(bool),
        typeof(BootstrapUninstallLoader),
    ...
    public BootstrapUninstallLoader()
    {
        InitializeComponent();
    ...
    {
        var loader = (BootstrapUninstallLoader)d;
